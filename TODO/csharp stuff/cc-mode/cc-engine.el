	 ...
	 (if (consp containing-sexp)
	   ...
	   (if (c-looking-at-inexpr-block)
	     ...
	     (when (and (or 
			...
			(eq (char-after) ?\[))
	       ;; In Java and C#, an initialization brace list may follow
		 ...
		 (setq braceassignp
		       (cond ((/= (c-backward-token-1 1 t lim) 0) nil)
			     ...
			     ((looking-at "\\sw\\|\\s_\\|[.[]")
			      ...
			      ;; identifier (may contain "." in Java and C#)
			      ;; or another "[]" sexp.
			      'dontknow)
			     (t nil)))))
...
(defun c-guess-basic-syntax ()
  (save-excursion
	...
	;; extern language definitions, possibly (in C++ and C#) namespace
	;; definitions.
	(save-excursion
	  (save-restriction
	    (widen)
...
(defun c-indent-line (&optional syntax)
  ;; indent the current line as C/C++/ObjC/C# code. Optional SYNTAX is the
